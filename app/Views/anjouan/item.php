        ...
        <div class="row"> 
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              if(stripos($jaugeage['cuve'], "ANJOUAN") !== false && $jaugeage['produit'] == "ESSENCE" && $jaugeage['date']==date('d/m/Y', strtotime(' -1 day'))){
                              $compteur_essence=$compteur_essence+$jaugeage['fin_compteur'];
                   }
              if(stripos($jaugeage['cuve'], "ANJOUAN") !== false && $jaugeage['produit'] == "GASOIL" && $jaugeage['date']==date('d/m/Y', strtotime(' -1 day'))){
                              $compteur_gasoil=$compteur_gasoil+$jaugeage['fin_compteur'];
                   }
              if(stripos($jaugeage['cuve'], "ANJOUAN") !== false && $jaugeage['produit'] == "PETROLE" && $jaugeage['date']==date('d/m/Y', strtotime(' -1 day'))){
                              $compteur_petrole=$compteur_petrole+$jaugeage['fin_compteur'];
                   }
              if(stripos($jaugeage['cuve'], "ANJOUAN") !== false && $jaugeage['produit'] == "JET A1" && $jaugeage['date']==date('d/m/Y', strtotime(' -1 day'))){
